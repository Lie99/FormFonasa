...
async function generatePDF() {
    ...
    pdf.rect(100, 400, 10, 10);
    pdf.rect(100, 500, 10, 10);
    pdf.rect(100, 600, 10, 10);
    pdf.rect(100, 700, 10, 10);
    pdf.rect(100, 800, 10, 10);
    pdf.rect(200, 100, 10, 10);
    pdf.rect(200, 200, 10, 10);
    pdf.rect(200, 300, 10, 10);
    pdf.rect(200, 400, 10, 10);
    pdf.rect(200, 500, 10, 10);
    pdf.rect(200, 600, 10, 10);
    pdf.rect(200, 700, 10, 10);
    pdf.rect(200, 800, 10, 10);
    pdf.rect(300, 100, 10, 10);
    pdf.rect(300, 200, 10, 10);
    pdf.rect(300, 300, 10, 10);
    pdf.rect(300, 400, 10, 10);
    pdf.rect(300, 500, 10, 10);
    pdf.rect(300, 600, 10, 10);
    pdf.rect(300, 700, 10, 10);
    pdf.rect(300, 800, 10, 10);
    pdf.rect(400, 100, 10, 10);
    pdf.rect(400, 200, 10, 10);
    pdf.rect(400, 300, 10, 10);
    pdf.rect(400, 400, 10, 10);
    pdf.rect(400, 500, 10, 10);
    pdf.rect(400, 600, 10, 10);
    pdf.rect(400, 700, 10, 10);
    pdf.rect(400, 800, 10, 10);
    pdf.rect(500, 100, 10, 10);
    pdf.rect(500, 200, 10, 10);
    pdf.rect(500, 300, 10, 10);
    pdf.rect(500, 400, 10, 10);
    pdf.rect(500, 500, 10, 10);
    pdf.rect(500, 600, 10, 10);
